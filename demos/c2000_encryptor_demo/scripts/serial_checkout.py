...
Usage:
    python3 demos/c2000_encryptor_demo/scripts/serial_checkout.py
    python3 demos/c2000_encryptor_demo/scripts/serial_checkout.py --port /dev/ttyACM0
    python3 demos/c2000_encryptor_demo/scripts/serial_checkout.py --verbose
