...
Usage:
  PYTHONPATH=tools/py/src python3 demos/apex_hil_demo/scripts/demo_customer.py
  PYTHONPATH=tools/py/src python3 demos/apex_hil_demo/scripts/demo_customer.py --host 192.168.1.119
"""
