#ifndef APEX_ESP32_ENCRYPTOR_ENGINE_HPP
#define APEX_ESP32_ENCRYPTOR_ENGINE_HPP
/**
...
public:
  ...
  bool isUartInitialized() const noexcept { return uart_.isInitialized(); }
...
#endif // APEX_ESP32_ENCRYPTOR_ENGINE_HPP
