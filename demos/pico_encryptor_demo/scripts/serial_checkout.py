...
Usage:
    python3 demos/pico_encryptor_demo/scripts/serial_checkout.py
    python3 demos/pico_encryptor_demo/scripts/serial_checkout.py --data-port /dev/ttyUSB1
    python3 demos/pico_encryptor_demo/scripts/serial_checkout.py --cmd-port /dev/ttyUSB2
    python3 demos/pico_encryptor_demo/scripts/serial_checkout.py --verbose
