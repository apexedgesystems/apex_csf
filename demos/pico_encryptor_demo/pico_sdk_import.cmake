...
set(PICO_SDK_FETCH_FROM_GIT
    ...
    CACHE BOOL "Set to ON to fetch copy of SDK from git if not otherwise locatable"
)
  ...
  if (PICO_SDK_FETCH_FROM_GIT)
    ...
    if (PICO_SDK_FETCH_FROM_GIT_PATH)
      get_filename_component(
        FETCHCONTENT_BASE_DIR "${PICO_SDK_FETCH_FROM_GIT_PATH}" REALPATH BASE_DIR
        "${CMAKE_SOURCE_DIR}"
      )
    endif ()
...
if (NOT EXISTS ${PICO_SDK_INIT_CMAKE_FILE})
  message(
    FATAL_ERROR "Directory '${PICO_SDK_PATH}' does not appear to contain the Raspberry Pi Pico SDK"
  )
endif ()
