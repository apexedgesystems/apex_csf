...
Usage:
    python3 demos/arduino_encryptor_demo/scripts/serial_checkout.py
    python3 demos/arduino_encryptor_demo/scripts/serial_checkout.py --port /dev/ttyACM1
    python3 demos/arduino_encryptor_demo/scripts/serial_checkout.py --verbose
