 ...
 * @brief Shared types, sizing traits, and utilities for encryptor applications.
 *
 * Extracted from arduino_encryptor_demo and stm32_encryptor to eliminate duplication.
 * Header-only -- no CMake library needed. Both apps include this via an
 * additional -I path in their CMakeLists.txt.
 *
 * Contains:
