...
docker compose run --rm -T dev-cuda bash -c '
  ./build/hosted-x86_64-debug/bin/ApexMcDemo \
    --runs 50000 \
    --seed 42 \
    --csv demos/apex_mc_demo/results/run_1/results.csv \
    --summary demos/apex_mc_demo/results/run_1/summary.csv
'
```
...
docker compose run --rm -T dev-cuda bash -c '
  ...
  mc-plot report \
    ../../demos/apex_mc_demo/results/run_1/results.csv \
    --output ../../demos/apex_mc_demo/results/run_1/
'
```
...
```bash
cd demos/apex_mc_demo/docs/results
...
RESULTS=demos/apex_mc_demo/results
