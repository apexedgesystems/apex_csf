...
Usage:
    ...
    python3 apps/esp32_encryptor_demo/scripts/serial_checkout.py --data-port /dev/ttyUSB1
    python3 apps/esp32_encryptor_demo/scripts/serial_checkout.py --cmd-port /dev/ttyACM1
    python3 apps/esp32_encryptor_demo/scripts/serial_checkout.py --verbose
