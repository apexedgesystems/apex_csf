#ifndef APEX_PICO_ENCRYPTOR_COMMAND_DECK_HPP
#define APEX_PICO_ENCRYPTOR_COMMAND_DECK_HPP
/**
 * @file CommandDeck.hpp
 * @brief Command channel handler for the pico_encryptor_demo.
 *
 * Owns the UART1 command pipeline: SLIP decode -> CRC validate ->
 ...
 *
 * Lifecycle:
 *  1. Construct with UART1, KeyStore, EncryptorEngine, and OverheadTracker
...
#endif // APEX_PICO_ENCRYPTOR_COMMAND_DECK_HPP
