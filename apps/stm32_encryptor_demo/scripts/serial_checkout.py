#!/usr/bin/env python3
"""
Firmware checkout script for NUCLEO-L476RG (stm32_encryptor_demo).
...
Usage:
    ...
    python3 apps/stm32_encryptor_demo/scripts/serial_checkout.py --data-port /dev/ttyUSB0
    python3 apps/stm32_encryptor_demo/scripts/serial_checkout.py --cmd-port /dev/ttyACM0
...
Checkout groups:
    ...
    10. Overhead        - DWT cycle measurement and fast-forward
...
def run_checkout(data_port: str, cmd_port: str, baud: int) -> int:
    ...
    print("STM32 Encryptor Checkout")
...
def main():
    ...
    parser.add_argument(
        ...
        help="Data channel port - FTDI/UART1 (default: %(default)s)",
    )
    parser.add_argument(
        "--cmd-port",
