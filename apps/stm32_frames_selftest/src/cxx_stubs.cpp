...
/* newlib libm error path (asin/acos domain checks) wants reentrant errno;
 * with -nostdlib there is no reentrancy support, so provide the storage. */
static int g_errno = 0;
extern "C" int* __errno() { return &g_errno; }
