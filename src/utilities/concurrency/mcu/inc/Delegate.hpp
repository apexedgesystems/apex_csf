#ifndef APEX_UTILITIES_CONCURRENCY_MCU_DELEGATE_HPP
#define APEX_UTILITIES_CONCURRENCY_MCU_DELEGATE_HPP
/**
 * @file Delegate.hpp
...
struct DelegateU8 {
  ...
  constexpr uint8_t operator()() const noexcept { return fn ? fn(ctx) : uint8_t{0}; }
...
#endif // APEX_UTILITIES_CONCURRENCY_MCU_DELEGATE_HPP
