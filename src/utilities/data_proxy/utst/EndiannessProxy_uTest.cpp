...
using system_core::data_proxy::EndianStatus;
...
TEST(EndiannessProxyNew, ScalarNoSwapCopies) {
...
TEST(EndiannessProxyNew, ScalarNoSwapSamePointerIsNoOp) {
...
TEST(EndiannessProxyNew, ScalarSwapUint32) {
  std::uint32_t in = 0x12345678;
  std::uint32_t out = 0;
...
TEST(EndiannessProxyNew, ScalarSwapUint16) {
...
TEST(EndiannessProxyNew, ScalarSwapUint64) {
...
TEST(EndiannessProxyNew, ScalarSwapUint8IsIdentity) {
  std::uint8_t in = 0xAB;
  std::uint8_t out = 0;
...
TEST(EndiannessProxyNew, ScalarSwapSigned) {
...
TEST(EndiannessProxyNew, ScalarSwapFloat) {
  float in = 1.0f;
  float out = 0.0f;
...
TEST(EndiannessProxyNew, ScalarSwapDouble) {
  double in = 1.0;
  double out = 0.0;
...
TEST(EndiannessProxyNew, StructNoSwapCopies) {
...
TEST(EndiannessProxyNew, StructSwapViaAdl) {
  TestPacket in{0x12345678, 0xABCD, 0xEF, 0x00};
  TestPacket out{};
...
TEST(EndiannessProxyNew, Accessors) {
  std::uint32_t in = 0;
  std::uint32_t out = 0;
...
TEST(EndiannessProxyNew, RoundTrip) {
...
TEST(EndiannessProxyNew, StructRoundTrip) {
