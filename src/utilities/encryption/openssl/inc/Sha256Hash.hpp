#ifndef APEX_UTILITIES_ENCRYPTION_SHA256_HASH_HPP
#define APEX_UTILITIES_ENCRYPTION_SHA256_HASH_HPP
/**
 * @file Sha256Hash.hpp
 * @brief SHA-256 hash adapter using OpenSSL EVP with C++17-compatible API.
 */
...
/**
 * @brief SHA-256 hash using OpenSSL EVP.
 *
 * Inherits from HashBase<Sha256Hash> for vector and zero-allocation APIs.
 */
class Sha256Hash : public HashBase<Sha256Hash> {
public:
  /**
...
#endif // APEX_UTILITIES_ENCRYPTION_SHA256_HASH_HPP
