#ifndef APEX_EXECUTIVE_MCU_FREE_RUNNING_SOURCE_HPP
#define APEX_EXECUTIVE_MCU_FREE_RUNNING_SOURCE_HPP
/**
 ...
 *
 * Use cases:
 *   - Unit testing McuExecutive on desktop
...
#endif // APEX_EXECUTIVE_MCU_FREE_RUNNING_SOURCE_HPP
