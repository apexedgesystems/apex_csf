#ifndef APEX_SYSTEM_CORE_POSIX_EXECUTIVE_BASE_HPP
#define APEX_SYSTEM_CORE_POSIX_EXECUTIVE_BASE_HPP
/**
 * @file PosixExecutiveBase.hpp
...
public:
  ...
  ~PosixExecutiveBase() override = default;
...
protected:
  ...
  PosixExecutiveBase() noexcept { setConfigured(true); }
...
#endif // APEX_SYSTEM_CORE_POSIX_EXECUTIVE_BASE_HPP
