#ifndef APEX_EXECUTIVE_LITE_ITICK_SOURCE_HPP
#define APEX_EXECUTIVE_LITE_ITICK_SOURCE_HPP
/**
 * @file ITickSource.hpp
 * @brief Abstract tick source interface for LiteExecutive.
 *
 ...
 *
 * LiteExecutive calls waitForNextTick() in its main loop, allowing the
...
#endif // APEX_EXECUTIVE_LITE_ITICK_SOURCE_HPP
