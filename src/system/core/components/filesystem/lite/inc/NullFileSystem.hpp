#ifndef APEX_FILESYSTEM_LITE_NULL_FILE_SYSTEM_HPP
#define APEX_FILESYSTEM_LITE_NULL_FILE_SYSTEM_HPP
/**
 ...
 * @note RT-safe: All methods are O(1) with no allocation.
 */
class NullFileSystem : public system_component::IComponent {
public:
...
#endif // APEX_FILESYSTEM_LITE_NULL_FILE_SYSTEM_HPP
