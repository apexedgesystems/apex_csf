...
/** @test EVENT_NOTIFICATION_TABLE_SIZE matches Config. */
TEST(EventNotification, TableSizeConstant) {
  EXPECT_EQ(EVENT_NOTIFICATION_TABLE_SIZE, system_core::data::Config::NOTIFICATION_COUNT);
}
