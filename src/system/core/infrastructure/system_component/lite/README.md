...
**Namespace:** `system_core::system_component::lite`
**Platform:** Cross-platform (bare-metal compatible)
**C++ Standard:** C++17
**Library:** `system_component_lite`
...
| ------------------- | ----------------------- | ------------ | ----------------------------------------- |
| `LiteComponentBase` | `LiteComponentBase.hpp` | Queries only | Minimal IComponent with static allocation |

| Question                                            | Answer                                             |
| --------------------------------------------------- | -------------------------------------------------- |
| What is the minimal component base for MCU targets? | `LiteComponentBase`                                |
| How do I implement a bare-metal component?          | Derive from `LiteComponentBase`, implement hooks   |
...
| Component with LiteExecutive                  | Yes                             |
...
class LedDriver : public system_core::system_component::lite::LiteComponentBase {
public:
...
- `src/system/core/infrastructure/system_component/apex/` -- Full-featured SystemComponentBase for Linux/RTOS
- `src/system/core/executive/lite/` -- LiteExecutive for MCU deployment
