/**
 * @file LiteComponentBase_uTest.cpp
 * @brief Unit tests for LiteComponentBase.
 */
...
/**
 * @brief Concrete test component for LiteComponentBase testing.
 */
class TestLiteComponent : public system_core::system_component::lite::LiteComponentBase {
public:
...
TEST(LiteComponentBase_DefaultConstruction, InitialStateIsCorrect) {
...
/* ----------------------------- LiteComponentBase Method Tests ----------------------------- */

/** @test init() calls doInit() and sets initialized flag on success. */
TEST(LiteComponentBase_Lifecycle, InitSuccessful) {
  TestLiteComponent comp;
...
TEST(LiteComponentBase_Lifecycle, InitIdempotent) {
  TestLiteComponent comp;
...
TEST(LiteComponentBase_Lifecycle, InitFailure) {
...
TEST(LiteComponentBase_Lifecycle, ResetClearsState) {
  TestLiteComponent comp;
  (void)comp.init();
...
TEST(LiteComponentBase_Lifecycle, ReinitAfterReset) {
  TestLiteComponent comp;
  (void)comp.init();
  comp.reset();
...
TEST(LiteComponentBase_Registration, SetInstanceIndex) {
  TestLiteComponent comp;
...
TEST(LiteComponentBase_Registration, InstanceIndexZero) {
  TestLiteComponent comp;
...
TEST(LiteComponentBase_Registration, MaxInstanceIndex) {
  TestLiteComponent comp;
...
/** @test LiteComponentBase satisfies IComponent interface. */
TEST(LiteComponentBase_Interface, ImplementsIComponent) {
  TestLiteComponent comp;
