...
TEST(Level1PhysicsTest, InverterInputLow) {
...
TEST(Level1PhysicsTest, InverterInputHigh) {
...
TEST(Level1PhysicsTest, TwoStageChain) {
...
TEST(Level1PhysicsTest, PassGateOnTransfer) {
...
TEST(Level1PhysicsTest, PassGateOffIsolation) {
...
TEST(Level1PhysicsTest, PassGateSelectivity) {
  ...
  solveNR(9, V, [&](MnaSystemSparse& mna) {
    ...
    for (int n : {5, 6, 7, 8})
      mna.addConductance(n, 0, GMIN_NODE);
  });
