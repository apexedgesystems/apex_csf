#ifndef APEX_PMOSDYNAMICLATCH_HPP
#define APEX_PMOSDYNAMICLATCH_HPP
/**
...
struct PmosDynamicLatchManager {
   ...
   */
  void forceNodeVoltage(algorithms::mna::NetID net, double voltage) {
...
private:
  ...
  std::unordered_map<algorithms::mna::NetID, std::size_t> nodeMap_;
};

} // namespace sim::electronics::chips::intel4004

#endif // APEX_PMOSDYNAMICLATCH_HPP
