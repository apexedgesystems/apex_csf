#ifndef APEX_INTEL4004GRIDLEVEL2_HPP
#define APEX_INTEL4004GRIDLEVEL2_HPP
/**
...
struct Intel4004GridLevel2 : Intel4004GridLevel1 {
   ...
   * @note RT-safe.
   */
  void stampLatchFeedbackTransistor(algorithms::mna::MnaSystemSparse& mna, std::size_t idx,
...
public:
  ...
  struct BootstrapCap {
    algorithms::mna::NetID gate;
    algorithms::mna::NetID source;
    std::uint8_t cluster;
    double valueF;
  };
...
#endif // APEX_INTEL4004GRIDLEVEL2_HPP
