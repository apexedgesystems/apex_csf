...
TEST(SpiceNetlistParserTest, ParseMinimal) {
...
TEST(SpiceNetlistParserTest, UniqueNets) {
...
TEST(SpiceNetlistParserTest, SkipsComments) {
...
TEST(SpiceNetlistParserTest, SkipsEmptyLines) {
...
TEST(SpiceNetlistParserTest, EmptyInput) {
...
TEST(SpiceNetlistParserTest, SpecialCharacterNets) {
...
TEST(SpiceNetlistParserTest, GndAsSignalNet) {
...
TEST(SpiceNetlistParserTest, DottedNetNames) {
...
TEST(SpiceNetlistParserTest, MalformedLinesSkipped) {
...
TEST(SpiceNetlistParserTest, NonMlinesSkipped) {
...
TEST(SpiceNetlistParserTest, LoadFullNetlist) {
...
TEST(SpiceNetlistParserTest, InvalidFileThrows) {
