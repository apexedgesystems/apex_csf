...
TEST(CmosInverterCircuitTest, InputLowOutputHigh) {
...
TEST(CmosInverterCircuitTest, InputHighOutputLow) {
  CmosInverterCircuit inv(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  inv.build();
  inv.setInput(VDD);
  double vout = inv.computeDC();
...
TEST(CmosInverterCircuitTest, TransferCurveMonotonic) {
  CmosInverterCircuit inv(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  inv.build();
...
TEST(CmosNandCircuitTest, BothLowOutputHigh) {
...
TEST(CmosNandCircuitTest, ALowBHighOutputHigh) {
  CmosNandCircuit nand(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  nand.build();
...
TEST(CmosNandCircuitTest, AHighBLowOutputHigh) {
  CmosNandCircuit nand(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  nand.build();
...
TEST(CmosNandCircuitTest, BothHighOutputLow) {
  CmosNandCircuit nand(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  nand.build();
...
TEST(CmosNorCircuitTest, BothLowOutputHigh) {
...
TEST(CmosNorCircuitTest, ALowBHighOutputLow) {
  CmosNorCircuit nor(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  nor.build();
...
TEST(CmosNorCircuitTest, AHighBLowOutputLow) {
  CmosNorCircuit nor(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  nor.build();
...
TEST(CmosNorCircuitTest, BothHighOutputLow) {
  CmosNorCircuit nor(VDD, W, L, NMOS_PARAMS, PMOS_PARAMS);
  nor.build();
...
TEST(CmosAndCircuitTest, TruthTable) {
...
TEST(CmosOrCircuitTest, TruthTable) {
...
TEST(CmosXorCircuitTest, TruthTable) {
...
TEST(CmosXnorCircuitTest, TruthTable) {
...
TEST(CmosGateCircuitsTest, MatchLogicGatesTruthTables) {
