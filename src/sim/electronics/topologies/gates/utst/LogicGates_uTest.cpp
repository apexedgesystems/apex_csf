...
TEST(LogicGatesTest, NotTruthTable) {
...
TEST(LogicGatesTest, AndTruthTable) {
...
TEST(LogicGatesTest, OrTruthTable) {
...
TEST(LogicGatesTest, NandTruthTable) {
...
TEST(LogicGatesTest, NorTruthTable) {
...
TEST(LogicGatesTest, XorTruthTable) {
...
TEST(LogicGatesTest, XnorTruthTable) {
