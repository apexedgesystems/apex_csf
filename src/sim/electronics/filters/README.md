...
**Namespace:** `sim::electronics::filters`
**Platform:** Linux-only
**C++ Standard:** C++23
...
The `ApexFilterDemo` app exercises this library end-to-end:

```bash
./build/native-linux-debug/bin/ApexFilterDemo
./build/native-linux-debug/bin/ApexFilterDemo --resistance 10e3 --capacitance 1e-6
./build/native-linux-debug/bin/ApexFilterDemo --vstep 3.3 --duration 5e-3
```
...
- `apps/apex_filter_demo/` -- example consumer
