...
TEST(BjtCommonEmitter, ConstructionStoresValues) {
...
TEST(BjtCommonEmitter, InitialStateIsZero) {
  BjtCommonEmitter amp(12.0, 1e3, 100e3);
 ...
 */
TEST(DISABLED_BjtCommonEmitter, DcBiasActiveRegion) {
...
TEST(DISABLED_BjtCommonEmitter, DcBiasSaturation) {
 ...
 * DISABLED: Same stamp limitation as DcBiasActiveRegion. */
TEST(DISABLED_BjtCommonEmitter, DcBiasCutoff) {
