...
namespace mna_cuda = sim::electronics::mna::cuda;
...
class PhaseFourPipelineFixture : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(PhaseFourPipelineFixture, OneIter_SmallVoltages_NoLimit) {
