...
#include "src/sim/electronics/intel4004/grid/inc/Intel4004SignalTracer.hpp"
...
using sim::electronics::intel4004::Intel4004SignalTracer;
...
TEST(Intel4004L0, LdmAccumulator) {
...
TEST(Intel4004L0, AccumulatorOps) {
  using namespace sim::electronics::intel4004;
...
TEST(Intel4004L0, MultiInstructionLdmNopLdm) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, LdmAccumulatorSingleInstruction) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, IacSingleInstruction) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, CmaSingleInstruction) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, AddRegisterSingleInstruction) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, LdRegisterSingleInstruction) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, MultiInstructionLdmNopLdm) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, MultiInstructionLdmAddLd) {
  using namespace sim::electronics::intel4004;
 ...
 */
TEST(Intel4004L1, MultiInstructionLdmIacCma) {
  using namespace sim::electronics::intel4004;
 ...
 * FIM is a 2-byte instruction: one behavioral step() consumes both bytes.
 */
TEST(Intel4004L1, MultiInstructionLdmSubWithCarry) {
  using namespace sim::electronics::intel4004;
