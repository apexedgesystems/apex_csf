...
TEST(Intel4004Cpu, DefaultConstruction) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, LdmAllValues) {
...
TEST(Intel4004Cpu, AddRegisters) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, AddWithCarryIn) {
  Intel4004Cpu cpu;
  cpu.registers[0] = 7;
  cpu.accumulator = 8;
  cpu.carry = true;
...
TEST(Intel4004Cpu, SubRegisters) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, SubWithBorrow) {
  Intel4004Cpu cpu;
  cpu.accumulator = 3;
  cpu.registers[0] = 9;
...
TEST(Intel4004Cpu, NestedSubroutines) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, CountingLoop) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, IszFallsThrough) {
  Intel4004Cpu cpu;
  cpu.registers[0] = 15;
...
TEST(Intel4004Cpu, AccumulatorOpsChain) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, RamWriteRead) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Instructions, TwoByteDetection) {
...
TEST(Intel4004Cpu, RegisterPairRoundTrip) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, StepWhenHalted) {
  Intel4004Cpu cpu;
  cpu.halted = true;
...
TEST(Intel4004Cpu, JcnTestPinHigh) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, StatusRegisterWriteRead) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Cpu, StatusRegisterReadAll) {
  Intel4004Cpu cpu;
  cpu.registers[0] = 0;
  cpu.registers[1] = 0;
...
TEST(Intel4004Cpu, RunMaxCycles) {
  Intel4004Cpu cpu;
...
TEST(Intel4004Instructions, DecodeRegister) {
