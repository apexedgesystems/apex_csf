#ifndef APEX_SIM_ELECTRONICS_CPU_INTEL4004_GATELEVEL_HPP
#define APEX_SIM_ELECTRONICS_CPU_INTEL4004_GATELEVEL_HPP
/**
...
struct Gate {
  ...
  mna::NetID outputNet;                  ///< Output net (between load and logic).
  std::vector<mna::NetID> inputNets;     ///< Input nets (logic transistor gates).
...
struct PassGate {
  ...
  mna::NetID clockNet;       ///< Gate signal (clock/timing).
  mna::NetID sourceNet;      ///< Data source.
  mna::NetID drainNet;       ///< Data destination.
};
...
public:
  ...
  bool netValue(mna::NetID net) const { return netState_[net]; }
   ...
   */
  void driveNet(mna::NetID net, bool value) {
...
#endif // APEX_SIM_ELECTRONICS_CPU_INTEL4004_GATELEVEL_HPP
