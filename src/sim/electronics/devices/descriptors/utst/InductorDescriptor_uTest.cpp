...
TEST(InductorDescriptorTest, DesignatedInitializers) {
...
TEST(InductorDescriptorTest, PositionalConstruction) {
...
TEST(InductorDescriptorTest, NanohenryRange) {
...
TEST(InductorDescriptorTest, MicrohenryRange) {
...
TEST(InductorDescriptorTest, MillihenryRange) {
...
TEST(InductorDescriptorTest, HenryRange) {
...
TEST(InductorDescriptorTest, GroundReferenced) {
...
TEST(InductorDescriptorTest, Floating) {
...
TEST(InductorDescriptorTest, SameNet) {
