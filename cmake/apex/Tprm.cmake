...
#
# Sequence slot lines carry decimal slots; the packer stores them under
# the reserved fullUid ranges and the executive extracts them to the
# rts/ / ats/ bank directories as {slot:03d}.rts/.ats for the action
# engine (onboard sequencing is mission-critical: the manifest is how a
# mission's sequence set ships).
# ==============================================================================
...
function (apex_add_tprm)
  ...
  foreach (_master IN LISTS _masters)
    ...
    foreach (_item IN LISTS _m_items_${_master})
      ...
      if (_kind STREQUAL "entry")
        ...
        set(_seq "${_src_dir}/${_path}")
        if (NOT EXISTS "${_seq}")
          message(FATAL_ERROR "apex_add_tprm(${ARG_NAME}): missing sequence ${_path} (${_master})")
        endif ()
  ...
  add_custom_target(apex_tprm_${ARG_NAME} ALL DEPENDS ${_master_outputs})
